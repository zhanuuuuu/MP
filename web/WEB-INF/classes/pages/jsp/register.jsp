...
<div id="wxApp">
    <form id="vipFormID" name="vipFrom" onsubmit="return checkUser();">
        <div class="vipFormWrapper">
            <ul class="vip_list">
                <li class="vip_item">
                    <span class="vip_form_title">办理积分卡所需信息</span>
                </li>
                <li class="vip_item">
                ...
                <li class="vip_item">
                    ...
                    <input title="name" class="vip_text" type="text" name="cTel" id="cTel">
                </li>
                ...
                <li class="vip_item">
                    ...
                    <input title="cIdCard" class="vip_text" type="text" name="cIdCard" id="idCard">
                </li>
...
<script type="text/javascript">
    ...
    function checkUser() {
        ...
        let inputs = [
            ...
            {"content": idCard, "exception": "身份证号不能为空", "id": 3},
            {"content": openid, "exception": "微信号获取失败", "id": 4}
        ];
        try {

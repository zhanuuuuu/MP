/**
 * Created by xwy_brh on 2017/8/22.
 */
var calUtil = {
    //当前日历显示的年份
    showYear:2015,
        ...
        for (w = 1; w < 6; w++) {
            ...
            for (d = 0; d < 7; d++) {
                ...
                if(ifHasSigned && typeof(myMonth[w][d]) != 'undefined'){
                    htmls.push("<div class='td_"+d+" on th_cell'>"+"<span class='table_cell_text'>" + (!isNaN(myMonth[w][d]) ? myMonth[w][d] : " ") + "</span></div>");
                } else {
                    htmls.push("<div class='td_"+d+" th_cell calendar_record'>"+"<span class='table_cell_text'>" + (!isNaN(myMonth[w][d]) ? myMonth[w][d] : " ") + "</span></div>");
                }
            }
            htmls.push("</div>");
        }
